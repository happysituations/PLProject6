...
_lr_productions = [
  ...
  ('atom -> SIMB','atom',1,'p_atom_simbol','yacc.py',229),
  ('atom -> bool','atom',1,'p_atom_bool','yacc.py',233),
  ('atom -> NUM','atom',1,'p_atom_num','yacc.py',237),
  ('atom -> TEXT','atom',1,'p_atom_word','yacc.py',241),
  ('atom -> <empty>','atom',0,'p_atom_empty','yacc.py',245),
  ('bool -> TRUE','bool',1,'p_true','yacc.py',249),
  ('bool -> FALSE','bool',1,'p_false','yacc.py',253),
  ('atom -> NIL','atom',1,'p_nil','yacc.py',257),
]
